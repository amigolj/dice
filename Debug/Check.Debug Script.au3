...
$TempOriginalFileBeingDebuggedFileName = "Check.au3"
$TempOriginalFileBeingDebuggedFileFolder = "C:\Users\admin\Desktop\DICE"
$TempOriginalFileBeingDebuggedFilePath = "C:\Users\admin\Desktop\DICE\Check.au3"
AutoIt_Debugger_LoadFile("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3")
AutoIt_Debugger_DebugFile(@ScriptFullPath)


SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 2, False))
#Include "C:\Users\admin\Desktop\DICE\Debug\mysql.Debug Script.au3"
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 2, False, @error, @extended))



SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 5, False))
Func Check()
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 5, False, @error, @extended))


SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 7, False))
	Local $sVar = RegRead("HKEY_LOCAL_MACHINE\Software\reg", "DKey")
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 7, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sVar")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sVar", $sVar))
	#CS If @error = 0 Then
		; Else
		; 	Exit 0
		; EndIf
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 13, False))
	If $sVar = "" Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 13, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sVar")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sVar", $sVar))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 14, False))
		$sVar = 1
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 14, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sVar")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sVar", $sVar))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 15, False))
	ElseIf $sVar = 100 Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 15, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sVar")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sVar", $sVar))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 16, False))
		Exit 0
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 16, False, @error, @extended))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 17, False))
	Else
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 17, False, @error, @extended))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 18, False))
		$sVar += 1
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 18, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sVar")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sVar", $sVar))

SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 19, False))
	EndIf
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 19, False, @error, @extended))


SetError(@error, @extended, AutoIt_Debugger_NextLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 21, False))
	RegWrite("HKEY_LOCAL_MACHINE\Software\reg", "DKey", "REG_DWORD", 2)
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("C:\Users\admin\Desktop\DICE\Check.au3", "Check.au3", 21, False, @error, @extended))
...
Func CheckForVariableChange($VariableName, $AutoItDebugger_ArrayIndexString,  $VariableValue)
   If $VariableName = "$sVar" Then
      AutoIt_Debugger_GetVariableFromEvent("$sVar", $sVar, $AutoItDebugger_ArrayIndexString, $VariableValue)
   EndIf
EndFunc
#cs ----------------------------------------------------------------------------
